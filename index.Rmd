...
$$
Differentiating log-likelihood with respect to $\Theta$ produces score function $l^{\prime}(\Theta)$, whilst differentiating one more time results in the [observed](https://online.stat.psu.edu/stat504/lesson/x-1/x-1.6/x-1.6.5-observed-and-expected-information) Fisher information $l^{\prime\prime}(\Theta_i)$:
$$
